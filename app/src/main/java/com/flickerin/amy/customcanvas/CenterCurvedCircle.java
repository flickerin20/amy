package com.flickerin.amy.customcanvas;
...
public class CenterCurvedCircle extends RelativeLayout {
    ...
    private void init(){
        ...
        xPaint.setColor(getResources().getColor(R.color.stylishbackcolor));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        CURVE_CIRCLE_RADIUS = getWidthSegregation(mNavigationBarWidth);
    ...
    private int getWidthSegregation(int width) {
        int segregation;

        int halfwidth = width/2;
        segregation = halfwidth/3;
